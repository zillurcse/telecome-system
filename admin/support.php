...
$message="";
  ...
  if(isset($_POST["addbtn"]))
 {
   ...
   $query=$db->query("INSERT INTO `support` (`id`,`support`) VALUES('1','$text')");
...
if(isset($_POST["edit"]))
 {
   ...
   $query=$db->query("REPLACE INTO `support` (`id`,`support`) VALUES('1','$text')");
...
if(isset($_POST["delate"]))
 {
   ...
   $query=$db->query("DELETE FROM `support` WHERE id='1'");
                ...
                <div class="row">
                    <div class="col-md-8" style="width: 100%;">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title text-uppercase">Support</h4>
                            </div>
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="10" id="myTextarea" class="form-control" placeholder="" value="" name="text"><?php print $fetch_data[1]; ?></textarea>
