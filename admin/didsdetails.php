...
if (!empty($text)) 
{
   ...
   $query=$db->query("INSERT INTO `didsdetails` (`id`,`didsdetails`) VALUES('1','$text')");
...
if(isset($_POST["edit"]))
 {
   ...
   $query=$db->query("REPLACE INTO `didsdetails` (`id`,`didsdetails`) VALUES('1','$text')");
...
if(isset($_POST["delate"]))
 {
   ...
   $query=$db->query("DELETE FROM `didsdetails` WHERE id='1'");
                ...
                <div class="row">
                    <div class="col-md-8" style="width: 100%;">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title text-uppercase">Dids Details</h4>
                            </div>
 <?php
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Details</label>
                                                <textarea rows="10" class="form-control" id="myTextarea" placeholder="Here can be your content us..." value="" name="text"><?php print $fetch_data[1]; ?></textarea>
