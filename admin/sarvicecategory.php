                ...
                <div class="row">
                    <div class="col-md-8" style="width: 100%;">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title text-uppercase">Add Sarvice Category</h4>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input style="border: 1px solid #b7b6b6;" type="number" class="form-control" placeholder="Index Number" value="<?php echo $fetch_data[0] ?>" name="id">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input style="border: 1px solid #b7b6b6;" type="text" class="form-control" placeholder="Category Name" value="<?php echo $fetch_data[1] ?>" name="text">
                                            </div>
                                        </div>
                                    </div>
...
<?php
  $query=$db->query("select * from sarvice");
...
?>
            ...
            <tr align="center">
                ...
                <td><a href="sarvicecategory.php?edits=<?php print $fetch_data[0];?>" class="btn btn-success btn-sm">Edit</a></td>
                <td><a href="sarvicecategory.php?delete=<?php print $fetch_data[0];?>" class="btn btn-danger btn-sm">Delete</a></td>
            </tr>
