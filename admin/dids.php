...
if($_SESSION["log"]==1) 
{
   ...
   @$uponpurehase=$_POST["uponpurehase"];
...
if(isset($_POST["addbtn"]))
 {
    ...
    if (!empty($id) && !empty($country)) 
    {
              ...
              $query=$db->query("INSERT INTO`dids`(`id`,`country`,`setupcost`,`monthlycost`,`incomecost`,`registration`,`uponpurehase`) values($id,'$country','$setupcost','$monthlycost','$incomecost','$registration','$uponpurehase')");
...
if (!empty($id) && !empty($country)) 
{
           ...
           $query=$db->query("REPLACE INTO`dids`(`id`,`country`,`setupcost`,`monthlycost`,`incomecost`,`registration`,`uponpurehase`) values($id,'$country','$setupcost','$monthlycost','$incomecost','$registration','$uponpurehase')");
...
if (isset($_GET["edits"])) {
   $id=$_GET["edits"];
   $query=$db->query("SELECT * FROM `dids` WHERE id='$id'");
...
if(isset($_GET["delete"]))
{
 $id=$_GET["delete"];
    ...
    $query=$db->query("delete from dids where id='$id'");
                ...
                <div class="row">
                    <div class="col-md-8" style="width: 100%;">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title text-uppercase">Dids</h4>
                            </div>
                                ...
                                <form>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Country</label>
                                                <input style="border: 1px solid #b7b6b6;" type="text" class="form-control" placeholder="Add Country" value="<?php echo $fetch_data[1] ?>" name="country">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input style="border: 1px solid #b7b6b6;" type="text" class="form-control" placeholder="" value="<?php echo $fetch_data[2] ?>" name="setupcost">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input style="border: 1px solid #b7b6b6;" type="text" class="form-control" placeholder="" value="<?php echo $fetch_data[3] ?>" name="monthlycost">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input style="border: 1px solid #b7b6b6;" type="text" class="form-control" placeholder=" " value="<?php echo $fetch_data[4] ?>" name="incomecost">
                                            </div>
                                        </div>
                                    </div>
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input style="border: 1px solid #b7b6b6;" type="text" class="form-control" placeholder="" value="<?php echo $fetch_data[5] ?>" name="registration">
                                            </div>
                                        </div>

                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Upon Purehase</label>
                                                <input style="border: 1px solid #b7b6b6;" type="text" class="form-control" placeholder=" " value="<?php echo $fetch_data[6] ?>" name="uponpurehase">
                                            </div>
                                        </div>
                                    </div>
...
?>
        ...
        <table class="table table-hover table-bordered" style="max-width: 1200px; background-color: #fff; margin: auto; margin-top: -200px;">
            ...
            <tr align="center" class="bg-info" colspan="8">
                <td>Id</td>
                <td>Country</td>
                <td>Setup Cost</td>
                <td>Monthly Cost</td>
...
<?php
  $query=$db->query("select * from dids");
...
?>
            ...
            <tr align="center">
                ...
                <td><a href="dids.php?edits=<?php print $fetch_data[0];?>" class="btn btn-success btn-sm">Edit</a></td>
                <td><a href="dids.php?delete=<?php print $fetch_data[0];?>" class="btn btn-danger btn-sm">Delete</a></td>
            </tr>
