...
$message="";
  ...
  if(isset($_POST["addbtn"]))
 {
   ...
   $query=$db->query("INSERT INTO `markting` (`id`,`markting`) VALUES('1','$text')");
...
if(isset($_POST["edit"]))
 {
   ...
   $query=$db->query("REPLACE INTO `markting` (`id`,`markting`) VALUES('1','$text')");
...
if(isset($_POST["delate"]))
 {
   ...
   $query=$db->query("DELETE FROM `markting` WHERE id='1'");
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navigation-example-2">
                        <span class="sr-only">Markting</span>
                ...
                <div class="row">
                    <div class="col-md-8" style="width: 100%;">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title text-uppercase">Markting</h4>
                            </div>
 <?php
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="10" id="myTextarea" class="form-control" placeholder="Here can be your content us..." value="" name="text"><?php print $fetch_data[1]; ?></textarea>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $.notify({
                icon: 'pe-7s-pen',
                message: "Mr. <b>Admin</b>Add New portfolio Project."
