...
if(isset($_POST["addbtn"]))
 {
    ...
    if (!empty($id) && !empty($group)) 
    {
              ...
              $query=$db->query("INSERT INTO`callrates`(`id`,`group`,`costper`,`increment`) values('$id','$group','$costper','$increment')");
...
if (!empty($id) && !empty($group)) 
{
           ...
           $query=$db->query("REPLACE INTO`callrates`(`id`,`group`,`costper`,`increment`) values('$id','$group','$costper','$increment')");
...
if (isset($_GET["edits"])) {
   $id=$_GET["edits"];
   $query=$db->query("SELECT * FROM `callrates` WHERE id='$id'");
...
if(isset($_GET["delete"]))
{
 $id=$_GET["delete"];
    ...
    $query=$db->query("delete from callrates where id='$id'");
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navigation-example-2">
                        <span class="sr-only">Call Rates</span>
                ...
                <div class="row">
                    <div class="col-md-8" style="width: 100%;">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title text-uppercase">Call Rates</h4>
                            </div>
                                ...
                                <form>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Group</label>
                                                <input style="border: 1px solid #b7b6b6;" type="text" class="form-control" placeholder=" " value="<?php echo $fetch_data[1] ?>" name="group">
                                            </div>
                                        </div>
                                    </div>
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input style="border: 1px solid #b7b6b6;" type="text" class="form-control" placeholder="" value="<?php echo $fetch_data[3] ?>" name="increment">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill" name="view" >Veiw </button>
...
<?php
  $query=$db->query("select * from callrates");
...
?>
            ...
            <tr align="center">
                ...
                <td><a href="callrates.php?edits=<?php print $fetch_data[0];?>" class="btn btn-success btn-sm">Edit</a></td>
                <td><a href="callrates.php?delete=<?php print $fetch_data[0];?>" class="btn btn-danger btn-sm">Delete</a></td>
            </tr>
