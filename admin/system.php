...
$message="";
  ...
  if(isset($_POST["addbtn"]))
 {
   ...
   $query=$db->query("INSERT INTO `system` (`id`,`system`) VALUES('1','$text')");
...
if(isset($_POST["edit"]))
 {
   ...
   $query=$db->query("REPLACE INTO `system` (`id`,`system`) VALUES('1','$text')");
...
if(isset($_POST["delate"]))
 {
   ...
   $query=$db->query("DELETE FROM `system` WHERE id='1'");
                ...
                <div class="row">
                    <div class="col-md-8" style="width: 100%;">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title text-uppercase">System</h4>
                            </div>
