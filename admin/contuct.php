...
$message="";
  ...
  if(isset($_POST["addbtn"]))
 {
   ...
   $query=$db->query("INSERT INTO `contuct` (`id`,`contuct`) VALUES('1','$text')");
...
if(isset($_POST["edit"]))
 {
   ...
   $query=$db->query("REPLACE INTO `contuct` (`id`,`contuct`) VALUES('1','$text')");
...
if(isset($_POST["delate"]))
 {
   ...
   $query=$db->query("DELETE FROM `contuct` WHERE id='1'");
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navigation-example-2">
                        <span class="sr-only">Contuct Us</span>
                ...
                <div class="row">
                    <div class="col-md-8" style="width: 100%;">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title text-uppercase">Contuct Us</h4>
                            </div>
 <?php
                                     $sql=$db->query("select * from contuct");
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="10" class="form-control" placeholder="Here can be your content us..." value="" id="myTextarea" name="text"><?php print $fetch_data[1]; ?></textarea>
