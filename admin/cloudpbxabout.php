...
if (!empty($text)) 
{
   ...
   $query=$db->query("INSERT INTO `cloudpbxabout` (`id`,`cloudpbxabout`) VALUES('1','$text')");
...
if(isset($_POST["edit"]))
 {
   ...
   $query=$db->query("REPLACE INTO `cloudpbxabout` (`id`,`cloudpbxabout`) VALUES('1','$text')");
...
if(isset($_POST["delate"]))
 {
   ...
   $query=$db->query("DELETE FROM `cloudpbxabout` WHERE id='1'");
                ...
                <div class="row">
                    <div class="col-md-8" style="width: 100%;">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title text-uppercase">Cloud PBX About</h4>
                            </div>
 <?php
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Details</label>
                                                <textarea rows="10" class="form-control" placeholder="Add Details" value="" id="myTextarea" name="text"><?php print $fetch_data[1]; ?></textarea>
