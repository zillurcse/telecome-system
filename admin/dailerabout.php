...
if (!empty($text)) 
{
   ...
   $query=$db->query("INSERT INTO `dailerabout` (`id`,`dailerabout`) VALUES('1','$text')");
...
if(isset($_POST["edit"]))
 {
   ...
   $query=$db->query("REPLACE INTO `dailerabout` (`id`,`dailerabout`) VALUES('1','$text')");
...
if(isset($_POST["delate"]))
 {
   ...
   $query=$db->query("DELETE FROM `dailerabout` WHERE id='1'");
                ...
                <div class="row">
                    <div class="col-md-8" style="width: 100%;">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title text-uppercase">Dailer About</h4>
                            </div>
 <?php
