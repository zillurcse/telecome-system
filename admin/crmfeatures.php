...
if (!empty($details) && !empty($title)) 
{
           ...
           $query=$db->query("INSERT INTO`crmfeatures`(`id`,`title`,`details`) values('$id','$title','$details')");
...
if (!empty($details) && !empty($title)) 
{
           ...
           $query=$db->query("REPLACE INTO`crmfeatures`(`id`,`title`,`details`) values('$id','$title','$details')");
...
if (isset($_GET["edits"])) {
   $id=$_GET["edits"];
   $query=$db->query("SELECT * FROM `crmfeatures` WHERE id='$id'");
...
if(isset($_GET["delete"]))
{
 $id=$_GET["delete"];
    ...
    $query=$db->query("delete from crmfeatures where id='$id'");
...
<head>
    ...
    <meta name="Developed By Figo nath" content="Figo Nath"/>
                ...
                <div class="row">
                    <div class="col-md-8" style="width: 100%;">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title text-uppercase">CRM Features</h4>
                            </div>
                                ...
                                <form method="post">
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Details</label>
                                                <textarea id="myTextarea" rows="10" class="form-control" placeholder="Here can be your content us..."  name="details"><?php echo $fetch_data[2] ?></textarea>
...
<?php
  $query=$db->query("select * from crmfeatures");
...
?>
            ...
            <tr align="center">
                ...
                <td><a href="crmfeatures.php?edits=<?php print $fetch_data[0];?>" class="btn btn-success btn-sm">Edit</a></td>
                <td><a href="crmfeatures.php?delete=<?php print $fetch_data[0];?>" class="btn btn-danger btn-sm">Delete</a></td>
            </tr>
