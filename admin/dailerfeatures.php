...
if (!empty($details) && !empty($title)) 
{
           ...
           $query=$db->query("INSERT INTO`dailerfeatures`(`id`,`title`,`dailerfeatures`) values('$id','$title','$details')");
...
if (!empty($details) && !empty($title)) 
{
           ...
           $query=$db->query("REPLACE INTO`dailerfeatures`(`id`,`title`,`dailerfeatures`) values('$id','$title','$details')");
...
if (isset($_GET["edits"])) {
   $id=$_GET["edits"];
   $query=$db->query("SELECT * FROM `dailerfeatures` WHERE id='$id'");
...
if(isset($_GET["delete"]))
{
 $id=$_GET["delete"];
    ...
    $query=$db->query("delete from dailerfeatures where id='$id'");
...
<?php
  $query=$db->query("select * from dailerfeatures");
...
?>
            ...
            <tr align="center">
                ...
                <td><a href="dailerfeatures.php?edits=<?php print $fetch_data[0];?>" class="btn btn-success btn-sm">Edit</a></td>
                <td><a href="dailerfeatures.php?delete=<?php print $fetch_data[0];?>" class="btn btn-danger btn-sm">Delete</a></td>
            </tr>
