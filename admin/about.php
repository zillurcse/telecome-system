...
if (!empty($text)) 
{
   ...
   $query=$db->query("INSERT INTO `about` (`id`,`about`) VALUES('1','$text')");
...
if(isset($_POST["edit"]))
 {
   ...
   $query=$db->query("REPLACE INTO `about` (`id`,`about`) VALUES('1','$text')");
...
if(isset($_POST["delate"]))
 {
   ...
   $query=$db->query("DELETE FROM `about` WHERE id='1'");
                ...
                <div class="row">
                    <div class="col-md-8" style="width: 100%;">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title text-uppercase">About Us</h4>
                            </div>
 <?php
