...
if (!empty($details) && !empty($title)) 
{
           ...
           $query=$db->query("INSERT INTO`callcenterfeatures`(`id`,`title`,`callcenterfeatures`) values('$id','$title','$details')");
...
if (!empty($details) && !empty($title)) 
{
           ...
           $query=$db->query("REPLACE INTO`callcenterfeatures`(`id`,`title`,`callcenterfeatures`) values('$id','$title','$details')");
...
if (isset($_GET["edits"])) {
   $id=$_GET["edits"];
   $query=$db->query("SELECT * FROM `callcenterfeatures` WHERE id='$id'");
...
if(isset($_GET["delete"]))
{
 $id=$_GET["delete"];
    ...
    $query=$db->query("delete from callcenterfeatures where id='$id'");
                ...
                <div class="row">
                    <div class="col-md-8" style="width: 100%;">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title text-uppercase">Call Center Features</h4>
                            </div>
...
<?php
  $query=$db->query("select * from callcenterfeatures");
...
?>
            ...
            <tr align="center">
                ...
                <td><a href="callcenterfeatures.php?edits=<?php print $fetch_data[0];?>" class="btn btn-success btn-sm">Edit</a></td>
                <td><a href="callcenterfeatures.php?delete=<?php print $fetch_data[0];?>" class="btn btn-danger btn-sm">Delete</a></td>
            </tr>
